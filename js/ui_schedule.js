...
function renderDailyServices() {
    ...
    html += '<div class="mt-4 overflow-x-auto rounded-xl border border-gray-200 shadow-inner bg-white"><table id="dailyScheduleTable" class="w-full table-fixed"><thead><tr>';
    for(let i = 0; i < 24; i++) {
        ...
        servicesStartingToday.forEach(inst => {
            ...
            html += `
                <tr class="hover:bg-gray-50 transition-colors group">
                    ...
                    <td class="px-4 py-3 text-right text-gray-600 font-mono text-xs">${inst.rate}</td>
