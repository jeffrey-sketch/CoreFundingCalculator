     ...
     placeholder.innerHTML = `
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="p-6 border border-gray-100 rounded-2xl bg-white shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                     ...
                     <!-- NEW: Remoteness Dropdown -->
                     <div class="mb-5 group">
                        <label for="remotenessSelect" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5 ml-1">Location / Remoteness (MMM 1-7)</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400"><i class="fas fa-map-marker-alt"></i></span>
                            <select id="remotenessSelect" class="w-full pl-10 p-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 appearance-none focus:bg-white transition-colors outline-none cursor-pointer">
                                <option value="National" selected>National (Standard MMM 1-5)</option>
                                <option value="Remote">Remote (MMM 6)</option>
                                <option value="Very Remote">Very Remote (MMM 7)</option>
                            </select>
                            <span class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-gray-400"><i class="fas fa-chevron-down"></i></span>
                        </div>
                    </div>

                    <!-- NEW: Category Sub-Budgets Tracking Box -->
            ...
            <div id="planDatesCard" class="p-6 border border-gray-100 rounded-2xl bg-white shadow-lg shadow-gray-200/50 hover:shadow-xl transition-shadow duration-300 flex flex-col">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 px-1 gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <!-- 州份選擇下拉選單 (State Selection Dropdown) -->
                        <select id="stateSelect" class="p-1.5 bg-gray-50 border border-gray-200 rounded-lg text-xs font-medium focus:ring-2 focus:ring-blue-500 outline-none text-gray-700 cursor-pointer">
                        ...
                        <!-- Restored ICS Import Button for Local/Custom Usage -->
                        <button id="importIcsBtn" class="p-1.5 bg-white border border-gray-200 text-blue-600 rounded-lg text-xs font-bold hover:bg-blue-50 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" title="Import Custom .ics">
                            <i class="fas fa-file-import"></i>
                        </button>
                        <input type="file" id="icsFileInput" accept=".ics" class="hidden">
                    </div>
                </div>
        ...
        <div class="space-y-8">
            ...
            <div id="overallSummarySection" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-0 overflow-hidden">
                ...
                <!-- Container for the new Category Budget Tracking table -->
                <div id="categoryBudgetSummaryContainer" class="p-6 border-b border-gray-100 empty:hidden"></div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <select id="modalServiceType" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            <!-- Options Split below -->
                            <option value="Self-Care Activities">Self-Care Activities</option>
                            <option value="Social and Community Access">Social and Community Access</option>
                    ...
                    <div id="modalWeeklyFields" class="space-y-4">
                        ...
                        <div id="modalFrequencyContainer">
                            <label for="modalFrequency" class="block text-sm font-semibold text-gray-700 mb-2">Frequency</label>
                            <select id="modalFrequency" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
        ...
        <div id="recurringServiceModalOverlay" class="fixed inset-0 z-[1200] hidden flex-col justify-center items-center backdrop-blur-sm bg-black/40">
            <div id="recurringServiceModalContent" class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[90vh] flex flex-col overflow-hidden">
                ...
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 bg-white z-10">
                    <h3 class="text-xl font-bold text-gray-800">Recurring Schedule Builder</h3>
                ...
                <div class="flex-grow overflow-y-auto p-6 bg-gray-50">
                    ...
                    <div class="p-6 border border-gray-100 rounded-2xl bg-white shadow-sm">
                        ...
                        <div id="weeklySummaryContainer" class="mt-8 pt-6 border-t border-gray-100" style="display:none;">
                            <h4 class="text-sm font-bold text-gray-800 mb-4">Recurring Support Summary</h4>
                                ...
                                <table class="min-w-full text-sm">
                                    <thead class="bg-gray-50 text-gray-600 font-medium">
                                        <tr class="text-left border-b border-gray-200">
                                            ...
                                            <th class="py-3 px-4 text-right">Cycle Total</th>
                                        </tr>
                                    </thead>
                                    <tbody id="weeklySummaryBody" class="divide-y divide-gray-100 bg-white"></tbody>
                                    <tfoot>
                                        <tr class="font-bold bg-gray-50 text-gray-800">
                                            <td colspan="4" class="py-3 px-4 text-right text-xs uppercase tracking-wider text-gray-500">Avg. Weekly Hours:</td>
